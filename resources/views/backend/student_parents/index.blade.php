    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            ...
            <div class="card-toolbar">
                ...
                <div class="dropdown dropdown-inline mr-2">
                    ...
                    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                        ...
                        <ul class="navi flex-column navi-hover py-2">
                            ...
                            <li class="navi-item">
                                <a href="{{ route('student_parents.report.xlsx') }}" class="navi-link">
                                    <span class="navi-icon">
                ...
                <!--end::Dropdown-->
                <!--begin::Button-->
                <a href="{{ route('student_parents.create') }}" class="btn btn-primary font-weight-bolder">
                    <span class="svg-icon svg-icon-md">
...
@section('scripts')
    <script>
        ...
        function blockManager(id) {
            ...
            xhr.open("GET", URL + 'student_parents/' + id);
            xhr.send();
        ...
        function interactWithModal(response) {
            if (response) {
                document.getElementById('modal-block-title').innerHTML = 'Info: ' + response.student_parent.fname + " " + response
                    .student_parent.lname;
    ...
    <script>
        ...
        function destoy(id, refrance) {
            axios.delete('/auto/student_parents/' + id)
                .then(function(response) {
                    // handle success
