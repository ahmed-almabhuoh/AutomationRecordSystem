            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="gender">
                        ...
                        @foreach (App\Models\Supervisor::GENDER as $gender)
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="status">
                        ...
                        @foreach (App\Models\Supervisor::STATUS as $status)
                ...
                <div class="form-group  mb-1 row supervisor-image">
                    <label class="col-form-label col-3 text-left" style="width: fit-content;">Supervisor Photo</label>
                    <div class="col-9">
