                ...
                @foreach ($student_parents as $student_parent)
                    <tr data-row="0" class="datatable-row" style="left: 0px;">
                        <td data-field="Country" aria-label="China" class="datatable-cell"><span
                                style="width: 121px;">{{ $student_parent->full_name }}</span></td>
                        <td data-field="ShipDate" aria-label="8/27/2017" class="datatable-cell"><span
                                style="width: 121px;">
                                @if ($student_parent->image)
                                    <img src="{{ Storage::url($student_parent->image) }}" id="student_parent-image" alt="-">
                                @else
                                    -
                                @endif
                            </span></td>
                        <td data-field="ShipDate" aria-label="8/27/2017" class="datatable-cell"><span
                                style="width: 121px;">{{ $student_parent->email }}</span></td>
                        <td data-field="Status" aria-label="6" class="datatable-cell"><span style="width: 121px;"><span
                                    class="{{ $student_parent->student_parent_status_class }}">{{ ucfirst($student_parent->status) }}</span></span>
                        </td>
                        <td data-field="Type" data-autohide-disabled="false" aria-label="2" class="datatable-cell">
                            <span style="width: 121px;"><span class="label label-primary label-dot mr-2"></span><span
                                    class="{{ $student_parent->student_parent_gender_class }}">{{ ucfirst($student_parent->gender) }}</span></span>
                        </td>


                        <td data-field="Type" data-autohide-disabled="false" aria-label="2" class="datatable-cell">
                            <span style="width: 121px;"><span
                                    class="label label-{{ $student_parent->student_parent_deletion_class }} label-dot mr-2">
                                </span>
                                <span
                                    class="font-weight-bold text-{{ $student_parent->student_parent_deletion_class }}">{{ $student_parent->student_parent_deletion }}</span>
                            </span>
                        </td>
                        ...
                        <td data-field="Actions" data-autohide-disabled="false" aria-label="null"
                            class="datatable-cell"><span style="overflow: visible; position: relative; width: 125px;">
                                <div class="dropdown dropdown-inline"> <a href="javascript:;"
                                        ...
                                        <ul class="navi flex-column navi-hover py-2">
                                            ...
                                            <li class="navi-item"> <a
                                                    href="{{ route('user.blocks', [
                                                        'blocked_id' => Crypt::encrypt($student_parent->id),
                                            ...
                                            <li class="navi-item">
                                                <a onclick="blockManager('{{ Crypt::encrypt($student_parent->id) }}')"
                                            ...
                                            <li class="navi-item"> <a
                                                    href="{{ route('student_parent.report.xlsx', Crypt::encrypt($student_parent->id)) }}"
                                                    class="navi-link"> <span class="navi-icon"><i
                                ...
                                </div> <a href="{{ route('student_parents.edit', Crypt::encrypt($student_parent->id)) }}"
                                    ...
                                    onclick="confirmDestroy('{{ Crypt::encrypt($student_parent->id) }}', this)"
