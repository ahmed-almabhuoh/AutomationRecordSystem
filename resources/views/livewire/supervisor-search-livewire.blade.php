                ...
                @foreach ($supervisors as $supervisor)
                    <tr data-row="0" class="datatable-row" style="left: 0px;">
                        ...
                        <td data-field="Status" aria-label="6" class="datatable-cell"><span style="width: 121px;"><span
                                    class="{{ $supervisor->supervisor_status_class }}">{{ ucfirst($supervisor->status) }}</span></span>
                        </td>
                        <td data-field="Type" data-autohide-disabled="false" aria-label="2" class="datatable-cell">
                            <span style="width: 121px;"><span class="label label-primary label-dot mr-2"></span><span
                                    class="{{ $supervisor->supervisor_gender_class }}">{{ ucfirst($supervisor->gender) }}</span></span>
                        </td>


                        <td data-field="Type" data-autohide-disabled="false" aria-label="2" class="datatable-cell">
                            <span style="width: 121px;"><span
                                    class="label label-{{ $supervisor->supervisor_deletion_class }} label-dot mr-2">
                                </span>
                                <span
                                    class="font-weight-bold text-{{ $supervisor->supervisor_deletion_class }}">{{ $supervisor->supervisor_deletion }}</span>
                            </span>
                        </td>
                                ...
                                <div class="dropdown dropdown-inline"> <a href="javascript:;"
                                    ...
                                    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                        <ul class="navi flex-column navi-hover py-2">
                                            ...
                                            <li class="navi-item"> <a
                                                    href="{{ route('supervisor.report.xlsx', Crypt::encrypt($supervisor->id)) }}"
                                                    class="navi-link"> <span class="navi-icon"><i
