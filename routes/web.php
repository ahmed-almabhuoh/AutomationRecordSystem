...
Route::prefix('/')->middleware(['auth:manager,admin,supervisor', 'activation', 'soft_deleted'])->group(function () {
...
Route::prefix('auto')->middleware(['guest:manager,admin,supervisor'])->group(function () {
